...
class SiameseNetwork(nn.Module):
    def __init__(self):
        ...
        self.cnn = CharacterLevelCNN(input_length=max_len, n_classes=5, input_dim=68, n_conv_filters=256, n_fc_neurons=1024)
        self.cnn.load_state_dict(torch.load('/content/drive/My Drive/vector.ai/entity-classifier.ckpt'))
